...
You are an expert Laravel developer (Laravel 10/11 preferred). I have an existing Laravel job board website at https://carejobber.com (healthcare-focused, Canada-based, with job seeker and employer dashboards, resume builder, job posting, basic search).
...
For my Laravel job board[](https://carejobber.com), implement a flexible subscription & package system.
...
My current site is https://carejobber.com (Laravel-based). I want to overhaul the employer/recruiter side, especially packages/subscriptions, resume database access, and job application flow.
