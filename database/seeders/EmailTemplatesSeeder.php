    ...
    public function run()
    {
        $templates = [
            ...
            [
                ...
                'body' => '<p>Hello <strong>{COMPANY_NAME}</strong>,</p><p>A new candidate has posted/updated their resume in your industry on {SITE_NAME}.</p><div style="background-color: #f8f9fa; border-left: 4px solid #667eea; padding: 20px; margin: 20px 0;"><p><strong>Candidate Information:</strong></p><ul><li><strong>Name:</strong> {USER_NAME}</li><li><strong>Job Category:</strong> {FUNCTIONAL_AREA}</li><li><strong>Career Level:</strong> {CAREER_LEVEL}</li><li><strong>Location:</strong> {LOCATION}</li></ul></div><p style="text-align: center;"><a href="{PROFILE_URL}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; padding: 15px 40px; text-decoration: none; border-radius: 6px;">View Resume</a></p><p>Warm regards,<br>{SITE_NAME} Team</p>',
                'shortcodes' => json_encode([
                    '{SITE_NAME}' => 'Website name',
                    '{SITE_URL}' => 'Website URL',
                    '{COMPANY_NAME}' => 'Company name',
                    '{USER_NAME}' => 'Job seeker name',
                    '{FUNCTIONAL_AREA}' => 'Job category',
            ...
            [
                ...
                'body' => '<p>Hello <strong>{COMPANY_NAME}</strong>,</p><p>Great news! A new candidate has registered on {SITE_NAME} whose profile matches your job posting.</p><div style="background-color: #f8f9fa; border-left: 4px solid #11998e; padding: 20px; margin: 20px 0;"><p><strong>Candidate Profile:</strong></p><ul><li><strong>Name:</strong> {USER_NAME}</li><li><strong>Job Category:</strong> {FUNCTIONAL_AREA}</li><li><strong>Career Level:</strong> {CAREER_LEVEL}</li><li><strong>Location:</strong> {USER_LOCATION}</li></ul><p><strong>Matching Job:</strong></p><ul><li><strong>Position:</strong> {JOB_TITLE}</li><li><strong>Posted:</strong> {JOB_POSTED_DATE}</li></ul></div><p style="text-align: center;"><a href="{USER_PROFILE_LINK}" style="display: inline-block; background: linear-gradient(135deg, #11998e 0%, #38ef7d 100%); color: #fff; padding: 15px 40px; text-decoration: none; border-radius: 6px;">View Candidate Profile</a></p><p><small>Note: Contact details are only available after the candidate applies to your job or you unlock their profile. This recommendation is based on matching job category and career level.</small></p><p>Warm regards,<br>{SITE_NAME} Team</p>',
                'shortcodes' => json_encode([
                    '{SITE_NAME}' => 'Website name',
                    '{SITE_URL}' => 'Website URL',
                    '{COMPANY_NAME}' => 'Company name',
                    '{USER_NAME}' => 'Candidate name',
                    '{FUNCTIONAL_AREA}' => 'Candidate job category',
