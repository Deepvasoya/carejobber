...
<div class="form-body">        
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'facebook_app_id') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'facebeek_app_secret') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'twitter_app_id') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'twitter_app_secret') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'google_app_id') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'google_app_secret') !!}">
