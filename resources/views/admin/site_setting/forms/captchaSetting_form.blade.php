...
<div class="form-body">        
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'nocaptcha_sitekey') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'nocaptcha_secret') !!}">
