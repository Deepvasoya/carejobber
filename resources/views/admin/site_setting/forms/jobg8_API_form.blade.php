...
<div class="form-body">
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'username_jobg8') !!}">
    ...
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'password_jobg8') !!}">
    ...
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'accountnumber_jobg8') !!}">
