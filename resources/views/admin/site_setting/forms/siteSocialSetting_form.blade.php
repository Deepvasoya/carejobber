...
<div class="form-body">        
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'facebook_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'google_plus_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'pinterest_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'twitter_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'instagram_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'linkedin_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'youtube_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'tumblr_address') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'flickr_address') !!}">
