...
<div class="form-body">        
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'video_title') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'video_text') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'video_link') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'video_id') !!}" id="video_id_div">
