...
<div class="form-body">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'seo_title') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'seo_description') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'seo_keywords') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'seo_other') !!}">
