...
<div class="form-body">        
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'marital_status') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}" id="marital_status_id_div">
