                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            <li class="nav-item active"> <a href="#Details" data-bs-toggle="tab" aria-expanded="false" class="nav-link active"> Details </a> </li>
                            <li><a href="#Summary" data-bs-toggle="tab" aria-expanded="false">Summary</a></li>
                            <li><a href="#CV" data-bs-toggle="tab" aria-expanded="false">C.V</a></li>
                            <li><a href="#Projects" data-bs-toggle="tab" aria-expanded="false">Projects</a></li>
                            <li><a href="#Experience" data-bs-toggle="tab" aria-expanded="false">Experience</a></li>
                            <li><a href="#Education" data-bs-toggle="tab" aria-expanded="false">Education</a></li>
                            <li><a href="#Skills" data-bs-toggle="tab" aria-expanded="false">Skills</a></li>
                            <li><a href="#Languages" data-bs-toggle="tab" aria-expanded="false">Languages</a></li>
                        </ul>

                        <div class="tab-content">              
                            <div class="tab-pane fade active in show" id="Details"> @include('admin.user.forms.form') </div>
