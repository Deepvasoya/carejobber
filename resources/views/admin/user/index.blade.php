                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" id="bulkDeleteUsers" class="btn btn-xs btn-danger" style="display:none;"><i class="fa fa-trash"></i> Bulk Delete</button>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on('change', '.checkboxes', function() {
        ...
        $('#selectAllUsers').prop('checked', totalCheckboxes === checkedCheckboxes);
        toggleBulkDeleteButton();
    });
    ...
    function toggleBulkDeleteButton() {
        ...
        if (checkedCount > 0) {
            $('#bulkDeleteUsers').show();
        } else {
            $('#bulkDeleteUsers').hide();
        }
    }
    
    // Bulk Delete functionality
    $('#bulkDeleteUsers').on('click', function() {
        var selectedIds = [];
