...
<div class="form-body">    
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'image') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'first_name') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'middle_name') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'last_name') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'state_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'city_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'phone') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'mobile_num') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_seeker_package_id') !!}"> 
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'is_immediate_available') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'verified') !!}">
