<div class="modal-body">
    <div class="form-body">
        <div class="form-group mb-3" id="div_name">
        ...
        <div class="form-group mb-3" id="div_image">
        ...
        <div class="form-group mb-3" id="div_url">
        ...
        <div class="form-group mb-3" id="div_date_start">
        ...
        <div class="form-group mb-3" id="div_date_end">
        ...
        <div class="form-group mb-3" id="div_is_on_going">
        ...
        <div class="form-group mb-3" id="div_description">
