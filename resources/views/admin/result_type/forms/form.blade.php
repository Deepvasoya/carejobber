...
<div class="form-body">        
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'result_type') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'result_type_id') !!}" id="result_type_id_div">
