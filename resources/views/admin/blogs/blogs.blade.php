                    ...
                    <div class="modal-content">
                        <form method="POST" files="true" action="{{ url(config('app.admin_prefix').'/blog') }}"
                            ...
                            <div class="modal-body">
                                ...
                                @endif
                                <div class="form-group mb-3 {{ $errors->has('title_update') ? 'has-error' : '' }}">
                                    <label class="control-label col-sm-3" for="title">Title</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group mb-3 {{ $errors->has('slug_update') ? 'has-error' : '' }}">
                                    <label class="control-label col-sm-3" for="Slug">Slug</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group mb-3 {{ $errors->has('content_update') ? 'has-error' : '' }}">
                                    <label class="control-label col-sm-3" for="content">Content</label>
                                    <div class="col-sm-12">
