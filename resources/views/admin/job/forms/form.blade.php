...
<div class="form-body">        
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'title') !!}">
	...
	<div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'benefits') !!}"> 
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'is_freelance') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'hide_salary') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
        ...
        {!! Form::text('expiry_date', null, array('class'=>'form-control', 'id'=>'expiry_date', 'placeholder'=>'Job expiry date', 'autocomplete'=>'off')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'expiry_date') !!}
    </div>
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'is_active') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'is_featured') !!}">
