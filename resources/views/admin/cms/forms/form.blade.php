...
<div class="form-body">	
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'page_slug') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'show_in_top_menu') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'show_in_footer_menu') !!}">
