                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            <li class="active"> <a href="#Details" data-bs-toggle="tab" aria-expanded="false"> Sort Industries </a> </li>
                        </ul>
                        <div class="tab-content">              
                            <div class="tab-pane fade active in show" id="Details"> @include('admin.industry.forms.sort') </div>
                        </div>
                    </div>
                </div>
            </div>
