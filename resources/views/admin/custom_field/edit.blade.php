            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                        <h4 class="header-title mb-0">{{ __('Edit Custom Field') }}</h4>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="custom-field-form" method="post" action="{{ route('update.custom.field', $field->id) }}">
                            @csrf
                            @method('PUT')
                            @include('admin.custom_field.forms.form', ['field' => $field, 'fieldTypes' => $fieldTypes, 'contextLabels' => $contextLabels, 'optionsText' => $optionsText])
                            <div class="mt-3">
