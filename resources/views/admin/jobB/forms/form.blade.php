...
<div class="form-body">        
    {!! Form::hidden('id', null) !!}
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'company_id') !!}" id="company_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'title') !!}">
	...
	<div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'benefits') !!}"> 
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'state_id') !!}" id="state_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'is_freelance') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_from') !!}" id="salary_from_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}" id="salary_currency_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'salary_period_id') !!}" id="salary_period_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'hide_salary') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
        {!! Form::label('functional_area_id', 'Job Category', ['class' => 'bold']) !!}
        {!! Form::select('functional_area_id', ['' => 'Select Job Category']+$functionalAreas, null, array('class'=>'form-control', 'id'=>'functional_area_id')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'functional_area_id') !!}                                       
    </div>
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_shift_id') !!}" id="job_shift_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'num_of_positions') !!}" id="num_of_positions_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
