...
<div class="form-body">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_title') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_title_id') !!}" id="job_title_id_div">
