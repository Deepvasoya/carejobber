                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            <li class="active"> <a href="#Details" data-bs-toggle="tab" aria-expanded="false"> FAQ </a> </li>
                        </ul>
                        {!! Form::open(array('method' => 'post', 'route' => 'store.faq', 'class' => 'form')) !!}
                        <div class="tab-content">              
                            <div class="tab-pane fade active in show" id="Details"> @include('admin.faq.forms.form') </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
