...
<div class="form-body">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_skill') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'job_skill_id') !!}" id="job_skill_id_div">
