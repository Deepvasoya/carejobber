            ...
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions"> 
                            <a href="{{ route('create.functional.area') }}" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-plus"></i> Add New Job Category</a>
                                ...
                                <table class="table table-striped table-bordered table-hover"  id="functionalAreaDatatableAjax">
                                    <thead>
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td><input type="text" class="form-control" name="functional_area" id="functional_area" autocomplete="off" placeholder="Job Category"></td>                      
