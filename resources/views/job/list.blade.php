                                            ...
                                            <div
                                                ...
                                                <div class="job-list-card-top">
                                                    <div class="job-list-card-badges">
                                                        @if (!empty($job->is_urgent))
                                                            <span class="job-list-pill job-list-pill-urgent"><i
                                                                    class="fas fa-fire"></i>
                                                                {{ __('Urgent hiring') }}</span>
                                                        @endif
                                                        @if (!empty($job->is_featured))
                                                            <span class="job-list-pill job-list-pill-featured"><i
                                                                    class="fas fa-bolt"></i> {{ __('Featured job') }}</span>
                                                        @endif
                                                        @if (!empty($job->is_highlighted))
                                                            <span class="job-list-pill job-list-pill-highlight"><i
                                                                    class="fas fa-star"></i> {{ __('Highlighted') }}</span>
                                                        @endif
                                                        @if ($hasApplied)
                                                            <span class="job-list-pill job-list-pill-applied"><i
                                                    ...
                                                    <div class="job-list-card-save">
                                                        @guest
                                                            <a href="{{ route('login') }}" class="job-list-save-btn"
                                                                title="{{ __('Sign in to save jobs') }}"
                                                                aria-label="{{ __('Save job') }}"><i
                                                                    class="far fa-heart"></i></a>
                                                        @else
                                                            @if (Auth::user()->isFavouriteJob($job->slug))
                                                                <a href="{{ route('remove.from.favourite', $job->slug) }}"
                                                                    class="job-list-save-btn job-list-save-btn-active"
                                                                    title="{{ __('Remove from saved') }}"
                                                                    aria-label="{{ __('Remove from saved') }}"><i
                                                                        class="fas fa-heart"></i></a>
                                                            @else
                                                                <a href="{{ route('add.to.favourite', $job->slug) }}"
                                                                    class="job-list-save-btn" title="{{ __('Save job') }}"
                                                                    aria-label="{{ __('Save job') }}"><i
                                                                        class="far fa-heart"></i></a>
                                                            @endif
                                                        @endguest
                                                ...
                                                <div class="job-list-card-main">
                                                    <div class="job-list-card-body">
                                                        ...
                                                        <h4 class="job-list-card-title"><a
                                                        ...
                                                        <dl class="job-list-card-meta">
                                                            <div class="job-list-meta-row">
                                                                <dt><i class="fas fa-money-bill-wave"></i>
                                                                    {{ __('Salary') }}</dt>
                                                                <dd>
                                                                    ...
                                                                    @else
                                                                        <span
                                                                            class="job-list-meta-muted">{{ __('Not disclosed') }}</span>
                                                                    @endif
                                                                </dd>
                                                            </div>
                                                            <div class="job-list-meta-row">
                                                                <dt><i class="fas fa-briefcase"></i> {{ __('Job type') }}
                                                                </dt>
                                                            ...
                                                            <div class="job-list-meta-row">
                                                                <dt><i class="fas fa-calendar-times"></i>
                                                                    {{ __('Application deadline') }}</dt>
                                                                <dd>
                                                                    @if ($job->expiry_date)
                                                    ...
                                                    <div class="job-list-card-actions job-list-card-actions--stack">
                                                        @if ($expired)
                                                            <span class="job-list-apply job-list-apply-disabled"><i
                                                                    class="fas fa-ban"></i> {{ __('Job closed') }}</span>
                                                        @elseif(Auth::check() && $hasApplied)
                                                            <span class="job-list-apply job-list-apply-done"><i
                                                        ...
                                                        @else
                                                            <a href="{{ route('login') }}"
                                                                class="job-list-apply job-list-apply-primary"><i
