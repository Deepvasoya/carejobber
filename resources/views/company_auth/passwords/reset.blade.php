                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('company.password.request') }}">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}" style="position: relative;">
                                ...
                                <i class="fas fa-eye" onclick="togglePasswordReset('password', this)" style="position: absolute; right: 15px; top: 38px; cursor: pointer; color: #999; z-index: 10;"></i>
                            ...
                            <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}" style="position: relative;">
                                ...
                                <i class="fas fa-eye" onclick="togglePasswordReset('password-confirm', this)" style="position: absolute; right: 15px; top: 38px; cursor: pointer; color: #999; z-index: 10;"></i>
