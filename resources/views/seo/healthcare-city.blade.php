    ...
    <div class="container">
        <div class="pseo-jobs-header">
            <div>
                ...
                <p>{{ __('Browse current healthcare jobs in') }} {{ $cityName }}. Medojob connects healthcare professionals with opportunities in hospitals, long-term care homes, assisted living facilities, home care agencies, clinics, and other healthcare settings throughout {{ $cityName }}.</p></br>

                <p>Currently, there are {{ number_format($jobCount) }} current healthcare jobs vacancies in {{ $cityName }}. Whether you are searching for healthcare careers {{ __(', like HCA, LPN, RN, unit clerk, Nurse Practitioners, food services, housekeeping, maintenance, or other healthcare careers,') }} this page helps you discover local opportunities in {{ $cityName }}. Positions may include full-time, part-time, casual, temporary, day, evening, weekend, and night shift roles.</p></br>
