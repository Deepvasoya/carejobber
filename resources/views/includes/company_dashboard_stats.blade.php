...
<ul class="row profilestat">
    ...
    <li class="col-lg-3 col-md-6 col-6">
        <a href="{{ route('posted.jobs') }}#active-jobs" class="inbox" title="{{ __('Manage jobs and view candidates') }}"> <i class="fas fa-user-friends" aria-hidden="true"></i>
            <h6>{{ Auth::guard('company')->user()->countJobApplications() }}
            <strong>{{ __('Job applications') }}</strong>
        </h6>
</a>
    </li>
     <li class="col-lg-3 col-md-6 col-6">
