...
<div class="newcvcard">
        ...
        <div class="cardhead">
                <h4 onclick="showProjects();">{{__('Projects')}}</h4>
                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#add_project_modal" onclick="showProfileProjectModal();"><i class="fas fa-plus"></i></a>
        </div>
