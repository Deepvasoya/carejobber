...
<div class="newcvcard">
                ...
                <div class="cardhead">
                    <h4 onclick="showLanguages();">{{__('Languages')}}</h4>
                    <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#add_language_modal" onclick="showProfileLanguageModal();"><i class="fas fa-plus"></i></a>
                </div>
