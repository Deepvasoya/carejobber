...
<div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">{{__('Add Your Resume or Cover Letter')}}</h1>
    ...
    <div class="modal-body">
        <div class="form-body">
            <div class="form-group" id="div_name">
                <label for="name" class="bold">{{__('Resume/Cover Letter Title')}}</label>
                <input class="form-control" id="title" placeholder="{{__('Resume/Cover Letter Title')}}" name="title" type="text" value="{{(isset($profileCv)? $profileCv->title:'')}}">
