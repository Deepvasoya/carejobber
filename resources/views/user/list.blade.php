                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="hmcate justify-content-center" title="Career Level"><i
                                            ...
                                            {{ $jobSeeker->getCareerLevel('career_level') }}
                                        </div>
                                        <div class="hmcate justify-content-center"><i
                                                class="fas fa-map-marker-alt"></i>
                                            {{ $jobSeeker->getCity('city') }}
                                        </div>
                                        @endif
                                    </div>
...
<style type="text/css">
    ...
    .resume-preview-card__text--muted {
        color: #64748b;
    }

    .resume-preview-card__strong {
        font-weight: 600;
        color: #0f172a;
    }

    .resume-preview-card__sub {
        margin-top: 0.15rem;
    }
