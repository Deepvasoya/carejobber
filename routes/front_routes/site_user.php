...
Route::get('candidate-payment-history', 'UserController@indexCandidateHistory')->name('candidate.list-payment-history');

Route::get('fetch-candidate-history', 'UserController@fetchCandidatesHistory')->name('candidate.fetch-history');
...
Route::post('request-account-deletion', 'UserController@requestAccountDeletion')->name('request.account.deletion');

/* * ******** User Referral Program ************ */
Route::get('user-referral-program', 'UserController@userReferralProgram')->name('user.referral.program');
Route::get('fetch-user-referral-history', 'UserController@fetchUserReferralHistory')->name('user.fetch.referral.history');
Route::post('send-user-referral-invite', 'UserController@sendUserReferralInvite')->name('user.send.referral.invite');
Route::post('activate-user-featured', 'UserController@activateUserFeatured')->name('user.activate.featured');