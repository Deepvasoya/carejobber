...
Route::post('bulk-delete-functional-areas', array_merge(['uses' => 'Admin\FunctionalAreaController@bulkDeleteFunctionalAreas'], $all_users))->name('bulk.delete.functional.areas');
