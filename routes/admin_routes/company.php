...
Route::post('bulk-delete-companies', array_merge(['uses' => 'Admin\CompanyController@bulkDeleteCompanies'], $all_users))->name('bulk.delete.companies');
...
Route::get('company-verification-document/{id}', array_merge(['uses' => 'Company\VerificationController@show'], $all_users))->name('admin.company.verification.document.show');
...
Route::post('save-claim-notes/{id}', array_merge(['uses' => 'Admin\CompanyController@saveClaimNotes'], $all_users))->name('admin.save.claim.notes');
