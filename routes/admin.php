...
// Empty array = any authenticated admin (any role). Use for dashboard and general admin routes.
$all_users = ['allowed_roles' => []];
...
include_once($real_path . 'certification.php');
