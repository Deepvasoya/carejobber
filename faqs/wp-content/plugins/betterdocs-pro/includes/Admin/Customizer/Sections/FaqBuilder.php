...
class FaqBuilder extends FreeFaqBuilder {
        ...
        $this->customizer->add_control(
            new RadioImageControl(
                ...
                [
                    ...
                    'choices'  => [
                        'layout-3' => [
                            'label' => __( 'Abstract Layout', 'betterdocs-pro' ),
    ...
    public function section_title_tag_mkb() {
        $this->customizer->add_setting( 'betterdocs_faq_section_title_tag_mkb', [
            'default'           => $this->defaults['betterdocs_faq_section_title_tag_mkb'],
            'capability'        => 'edit_theme_options',
        ...
        $this->customizer->add_control(
            new WP_Customize_Control(
                $this->customizer,
                'betterdocs_faq_section_title_tag_mkb',
                [
                    'label'    => __( 'Section Title Tag', 'betterdocs-pro' ),
                    'section'  => 'betterdocs_faq_section',
                    'settings' => 'betterdocs_faq_section_title_tag_mkb',
                    'type'     => 'select',
                    'choices'  => [
                        'h1' => 'h1',
                        'h2' => 'h2',
    ...
    public function group_title_tag_mkb() {
        $this->customizer->add_setting( 'betterdocs_faq_group_title_tag_mkb', [
            'default'           => $this->defaults['betterdocs_faq_group_title_tag_mkb'],
            'capability'        => 'edit_theme_options',
            'sanitize_callback' => [$this->sanitizer, 'choices']
        ] );
        ...
        $this->customizer->add_control(
            new WP_Customize_Control(
                $this->customizer,
                'betterdocs_faq_group_title_tag_mkb',
                [
                    'label'    => __( 'Group Title Tag', 'betterdocs-pro' ),
                    'section'  => 'betterdocs_faq_section',
                    'settings' => 'betterdocs_faq_group_title_tag_mkb',
                    'type'     => 'select',
                    'choices'  => [
                        'h1' => 'h1',
                        'h2' => 'h2',
