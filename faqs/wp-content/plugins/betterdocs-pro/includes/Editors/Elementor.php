...
use WPDeveloper\BetterDocsPro\Editors\Elementor\Widget\EncyclopediaBreadcrumb;
use WPDeveloper\BetterDocsPro\Editors\Elementor\Widget\BetterdocsEncyclopedia;
use WPDeveloper\BetterDocsPro\Editors\Elementor\Widget\EncyclopediaNavigation;
use WPDeveloper\BetterDocsPro\Editors\Elementor\Widget\EncyclopediaDescription;
...
class Elementor extends FreeElementor {
    ...
    public function pro_widgets( $widgets ) {
        ...
        $widgets['betterdocs-elementor-encyclopedia-navigation']     = EncyclopediaNavigation::class;
        $widgets['betterdocs-elementor-encyclopedia-widget']         = BetterdocsEncyclopedia::class;
        $widgets['betterdocs-el-elementor-encyclopedia-description'] = EncyclopediaDescription::class;
        $widgets['betterdocs-el-elementor-encyclopedia-breadcrumb']  = EncyclopediaBreadcrumb::class;
