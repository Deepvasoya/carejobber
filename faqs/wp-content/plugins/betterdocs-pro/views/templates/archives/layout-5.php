<?php
    ...
    $popular_title_tag     = betterdocs()->customizer->defaults->get( 'betterdocs_docs_page_popular_title_tag' );
    $popular_title_tag     = betterdocs()->template_helper->is_valid_tag( $popular_title_tag );
