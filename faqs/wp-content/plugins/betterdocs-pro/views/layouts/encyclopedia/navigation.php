...
$url = home_url() . '/' . $slug . '/';
$extra_class_ = isset($widget_type) && $widget_type== 'blocks' ? $blockId : '';
?>

<div class="<?php echo $extra_class_; ?>encyclopedia-alphabets alphabets-style-<?php echo esc_attr($alphabet_list_style); ?>">
    <ul class="encyclopedia-alphabet-list">
        ...
        $range = Helper::get_character_range($enable_non_latin, $script);
