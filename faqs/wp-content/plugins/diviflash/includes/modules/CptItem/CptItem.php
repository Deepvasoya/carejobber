    ...
    public function render( $attrs, $content, $render_slug ) {
        ...
        if('select' !== $this->props['type']) {
            ...
            if('acf_fields' === $this->props['type'] && class_exists('ACF') && 'on' === $this->acf_extension) {
                ...
                $acf_key = $this->props['post_type_for_acf'];
                $type_settings['acf_field'] = $this->props['post_type_for_acf'] !== '' && $this->props['post_type_for_acf'] !== 'select' && isset($this->props[$acf_key]) ?
                    $this->props[$acf_key] : '';
            ...
            if('pod_fields' === $this->props['type'] && class_exists('Pods') && 'on' === $this->pod_extension ) {
                ...
                $pod_key = "pod-".$this->props['post_type_for_pod'];
                $type_settings['pod_field']          = $this->props['post_type_for_pod'] !== '' && $this->props['post_type_for_pod'] !== 'select' && isset($this->props[$pod_key]) ?
                    $this->props[$pod_key] : '';
	        ...
	        if('metabox_fields' === $this->props['type'] && class_exists($this->metabox_dependent_class) && 'on' === $this->metabox_extension) {
		        ...
		        $metabox_key = "metabox-".$this->props['post_type_for_metabox'];
                $type_settings['metabox_field']             = '' !== $this->props['post_type_for_metabox'] && 'select' !== $this->props['post_type_for_metabox'] && isset($this->props[$metabox_key]) ? $this->props[$metabox_key] : '';
