...
class SiteSettingFormRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'location_multiple_fields' => 'required|boolean',
            'location_levels' => 'required|integer|in:1,2,3,4',
            'location_field_1_label' => 'nullable|max:50',
            'location_field_2_label' => 'nullable|max:50',
            'location_field_3_label' => 'nullable|max:50',
            'location_field_4_label' => 'nullable|max:50',
