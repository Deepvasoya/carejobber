        ...
        return Datatables::of($cmsContent)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a class="dropdown-item" href="' . route('edit.cmsContent', ['id' => $cmsContent->id]) . '"><i class="ri ri-pencil-line me-1"></i>Edit</a>
						</li>						
						<li>
							<a class="dropdown-item" href="javascript:void(0);" onclick="delete_cmsContent(' . $cmsContent->id . ');""><i class="ri ri-delete-bin-line me-1"></i>Delete</a>
						</li>																																							
					</ul>
				</div>';
                        })
