        ...
        return Datatables::of($careerLevels)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a class="dropdown-item" href="' . route('edit.career.level', ['id' => $careerLevels->id]) . '"><i class="ri ri-pencil-line me-1"></i>Edit</a>
						</li>						
						<li>
							<a class="dropdown-item" href="javascript:void(0);" onclick="deleteCareerLevel(' . $careerLevels->id . ', ' . $careerLevels->is_default . ');""><i class="ri ri-delete-bin-line me-1"></i>Delete</a>
						</li>
						<li>
						<a class="dropdown-item" href="javascript:void(0);" onClick="' . $activeHref . '" id="onclickActive' . $careerLevels->id . '"><i class="ri ri-' . $activeIcon . ' me-1"></i>' . $activeTxt . '</a>
						</li>																																		
					</ul>
				</div>';
                        })
