...
class CityController extends Controller
{
    ...
    public function storeCity(CityFormRequest $request)
    {
        ...
        if ($request->hasFile('upload_image')) {
            ...
            $fileName = ImgUploader::UploadImage('city_images', $image, $request->input('city'), 700, 1000, false);
        ...
        return Datatables::of($cities)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a class="dropdown-item" href="' . route('edit.city', ['id' => $cities->id]) . '"><i class="ri ri-pencil-line me-1"></i>Edit</a>
						</li>						
						<li>
							<a class="dropdown-item" href="javascript:void(0);" onclick="deleteCity(' . $cities->id . ', ' . $cities->is_default . ');"><i class="ri ri-delete-bin-line me-1"></i>Delete</a>
						</li>
						<li>
						<a class="dropdown-item" href="javascript:void(0);" onClick="' . $activeHref . '" id="onclickActive' . $cities->id . '"><i class="ri ri-' . $activeIcon . ' me-1"></i>' . $activeTxt . '</a>
						</li>																																		
					</ul>
				</div>';
                        })
