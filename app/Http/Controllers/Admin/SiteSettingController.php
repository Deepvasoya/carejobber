...

{
...

    {
        ...
        $siteSetting->is_featured_package_active_jobseeker = $request->input('is_featured_package_active_jobseeker');
        ...
        // Iyzico fields
        $siteSetting->iyzico_api_key = $request->input('iyzico_api_key') ?? null;
        $siteSetting->iyzico_secret_key = $request->input('iyzico_secret_key') ?? null;
        $siteSetting->iyzico_live_sandbox = $request->input('iyzico_live_sandbox') ?? 'sandbox';
        $siteSetting->is_iyzico_active = $request->input('is_iyzico_active') ?? 0;

        // GDPR Cookie Policy fields
        $siteSetting->gdpr_enabled = $request->input('gdpr_enabled') ?? 0;
        $siteSetting->gdpr_cookie_text = $request->input('gdpr_cookie_text') ?? null;
        $siteSetting->gdpr_cookie_button_text = $request->input('gdpr_cookie_button_text') ?? 'Accept';
        $siteSetting->gdpr_privacy_policy_url = $request->input('gdpr_privacy_policy_url') ?? null;
        $siteSetting->gdpr_cookie_details = $request->input('gdpr_cookie_details') ?? null;
