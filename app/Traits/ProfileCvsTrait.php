...
trait ProfileCvsTrait
{
    ...
    public function showProfileCvs(Request $request, $user_id)
    {
        ...
        $html = '<div class="col-mid-12"><table class="table table-striped"><thead class="table-light"><tr>
        ...
        if (isset($user) && count($user->profileCvs)):
            ...
            foreach ($user->profileCvs as $cv):
                ...
                <tr id="cv_' . $cv->id . '">
                    ...
                    <td><span class="text text-dark">' . $addedDate . '</span></td>
                    <td><a href="' . asset("cvs/$cv->cv_file") . '" download title="' . $cv->title . '"><i class="fas fa-download"></i></a> <a href="javascript:;" onclick="showProfileCvEditModal(' . $cv->id . ');" class="text text-dark ms-2"><i class="fas fa-pencil-alt"></i></a> <a href="javascript:;" onclick="delete_profile_cv(' . $cv->id . ');" class="text text-danger ms-2"><i class="fas fa-times"></i></a></td>
                </tr>';
            endforeach;
        endif;
