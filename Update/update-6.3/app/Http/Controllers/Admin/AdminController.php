    ...
    public function fetchAdminUsersData()
    {
        ...
        return Datatables::of($users)
                        ->addColumn('action', function ($user) {
                            return '<a class="btn btn-sm btn-primary me-2" href="' . route('edit.admin.user', ['id' => $user->id]) . '" class="btn btn-xs btn-primary"><i class="ri ri-edit-box-line me-1"></i> Edit</a><a class="btn btn-sm btn-danger" href="javascript:void(0);" onclick="delete_user(' . $user->id . ');" class="btn btn-xs btn-danger"><i class="ri ri-delete-bin-line me-1"></i> Delete</a>';
                        })
