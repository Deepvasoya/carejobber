...
class FunctionalAreaController extends Controller
{
    ...
    public function bulkDeleteFunctionalAreas(Request $request)
    {
    ...
    public function fetchFunctionalAreasData(Request $request)
    {
        ...
        return Datatables::of($functionalAreas)
                        ...
                        ->addColumn('checkbox', function ($functionalAreas) {
                            return '<input class="checkboxes" type="checkbox" id="check_'.$functionalAreas->id.'" name="functional_area_ids[]" autocomplete="off" value="'.$functionalAreas->id.'">';
                        })
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a class="dropdown-item" href="' . route('edit.functional.area', ['id' => $functionalAreas->id]) . '"><i class="ri ri-pencil-line me-1"></i>Edit</a>
						</li>						
						<li>
							<a class="dropdown-item" href="javascript:void(0);" onclick="deleteFunctionalArea(' . $functionalAreas->id . ', ' . $functionalAreas->is_default . ');"><i class="ri ri-delete-bin-line me-1"></i>Delete</a>
						</li>
						<li>
						<a class="dropdown-item" href="javascript:void(0);" onClick="' . $activeHref . '" id="onclickActive' . $functionalAreas->id . '"><i class="ri ri-' . $activeIcon . ' me-1"></i>' . $activeTxt . '</a>
						</li>																																		
					</ul>
				</div>';
                        })
                        ->rawColumns(['functional_area', 'action', 'checkbox'])
