        ...
        return Datatables::of($cms)
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							<a class="dropdown-item" href="' . route('edit.cms', ['id' => $cms->id]) . '"><i class="ri ri-pencil-line me-1"></i>Edit</a>
						</li>						
						<li>
							<a class="dropdown-item" href="javascript:void(0);" onclick="delete_cms(' . $cms->id . ');""><i class="ri ri-delete-bin-line me-1"></i>Delete</a>
						</li>																																							
					</ul>
				</div>';
                        })
