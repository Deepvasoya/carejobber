...
<div class="form-body">
    ...
    <div class="form-group mb-3">
            ...
            <div class="image_append" id="image_append">
                @if((isset($functionalArea)) && $functionalArea->image!='')
                <br>
                <div class='featured-images-main' id='listing_img_{{$functionalArea->id}}'><img  src="{{asset('uploads/functional_area/thumbnail/')}}/{{$functionalArea->image}}"></div>
                @endif
            </div>
        </div>
