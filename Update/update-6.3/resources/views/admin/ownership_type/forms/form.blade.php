...
<div class="form-body">        
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'ownership_type') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'ownership_type_id') !!}" id="ownership_type_id_div">
