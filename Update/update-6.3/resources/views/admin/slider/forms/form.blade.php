...
<div class="form-body">        
    {!! Form::hidden('id', null) !!}
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'lang') !!}" id="lang_div">
    ...
    @endif    
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'slider_image') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'slider_heading') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'slider_description') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'slider_link') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'slider_link_text') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'slider_id') !!}" id="slider_id_div">
