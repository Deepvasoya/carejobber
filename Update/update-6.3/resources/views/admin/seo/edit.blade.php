                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        <ul class="nav nav-tabs">              
                            <li class="nav-item active"> <a href="#seo" class="nav-link active" data-bs-toggle="tab" aria-expanded="false"> SEO </a> </li>
                        </ul>
                        {!! Form::model($seo, array('method' => 'put', 'route' => array('update.seo', $seo->id), 'class' => 'form', 'files'=>true)) !!}
                        {!! Form::hidden('id', $seo->id) !!}            
                        <div class="tab-content">              
                            <div class="tab-pane fade active in show" id="seo"> @include('admin.seo.forms.form') </div>
                        </div>
