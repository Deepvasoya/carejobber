...
<div class="form-body">        
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'degree_type') !!}">
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'degree_type_id') !!}" id="degree_type_id_div">
