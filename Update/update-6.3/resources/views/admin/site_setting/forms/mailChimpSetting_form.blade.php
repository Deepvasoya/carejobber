...
<div class="form-body">        
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mailchimp_api_key') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mailchimp_list_name') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mailchimp_list_id') !!}">
