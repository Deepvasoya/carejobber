...
<div class="form-body">
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mail_driver') !!}">
    ...
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mail_host') !!}">
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mail_port') !!}">
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mail_encryption') !!}">
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mail_username') !!}">
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'mail_password') !!}">
