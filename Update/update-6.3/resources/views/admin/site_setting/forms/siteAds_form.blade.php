...
<div class="form-body">        
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'index_page_below_top_employes_ad') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'above_footer_ad') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'dashboard_page_ad') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'cms_page_ad') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'listing_page_vertical_ad') !!}">
    ...
    <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'listing_page_horizontal_ad') !!}">
