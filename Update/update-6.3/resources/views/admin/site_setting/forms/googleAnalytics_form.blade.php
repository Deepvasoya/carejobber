...
<div class="form-body">
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'ganalytics') !!}">
    ...
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'google_tag_manager_for_head') !!}">
    ...
    <fieldset>
        ...
        <div class="form-group mb-3 mb-3 {!! APFrmErrHelp::hasError($errors, 'google_tag_manager_for_body') !!}">
