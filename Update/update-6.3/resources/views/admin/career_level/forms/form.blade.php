...
<div class="form-body">
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'lang') !!}"> {!! Form::label('lang', 'Language', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'career_level') !!}"> {!! Form::label('career_level', 'Career Level', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'is_default') !!}"> {!! Form::label('is_default', 'Is Default?', ['class' => 'bold']) !!}
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div"> {!! Form::label('career_level_id', 'Default Career Level', ['class' => 'bold']) !!}                    
    ...
    <div class="form-group mb-3 {!! APFrmErrHelp::hasError($errors, 'is_active') !!}"> {!! Form::label('is_active', 'Active', ['class' => 'bold']) !!}
        <div class="radio-list">
            <?php
